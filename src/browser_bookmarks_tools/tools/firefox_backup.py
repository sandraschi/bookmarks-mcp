...
async def _backup_firefox_data(
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to backup Firefox data: {e!s}",
            "profile_name": profile_name,
            "backup_path": backup_path,
            "backup_result": {},
        }
...
async def _restore_firefox_data(profile_name: str | None, restore_path: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to restore Firefox data: {e!s}",
            "profile_name": profile_name,
            "restore_path": restore_path,
            "restore_result": {},
        }
...
async def _create_session(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to create Firefox session: {e!s}",
            "profile_name": profile_name,
            "session_result": {},
        }
