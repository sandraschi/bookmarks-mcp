...
async def _get_firefox_platform() -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to get Firefox platform: {e!s}",
            "platform_info": {},
        }
...
async def _get_firefox_profile_directory() -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to get Firefox profile directory: {e!s}",
...
async def _get_firefox_places_db_path(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "database_path": (
                f"C:\\Users\\Username\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\{profile_name}\\places.sqlite"
            ),
        ...
        return {
            "success": False,
            "error": f"Failed to get Firefox places database path: {e!s}",
            "profile_name": profile_name,
            "database_path": None,
        }
...
async def _is_firefox_running() -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to check if Firefox is running: {e!s}",
            "is_running": False,
        }


async def _check_firefox_database_access_safe(profile_name: str | None, check_access: bool) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to check Firefox database access: {e!s}",
            "profile_name": profile_name,
...
async def _test_firefox_database_connection(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to test Firefox database connection: {e!s}",
            "profile_name": profile_name,
            "connection_result": {"success": False, "error": str(e)},
        }


async def _get_firefox_database_info(profile_name: str | None, include_info: bool) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to get Firefox database info: {e!s}",
            "profile_name": profile_name,
            "database_info": {},
        }
