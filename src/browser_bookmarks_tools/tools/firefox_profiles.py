...
from browser_bookmarks_tools.operation_types import FirefoxProfilesOperation
from browser_bookmarks_tools.tool_responses import unknown_operation_response
from browser_bookmarks_tools.tools.firefox.db import FirefoxDB
...
async def firefox_profiles(
    ...
    if operation == "get_firefox_profiles":
        ...
        return await _create_loaded_profile(profile_name, source_profiles, include_bookmarks, include_settings)
...
async def _get_firefox_profiles() -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to get Firefox profiles: {e!s}",
            "profiles": [],
            "count": 0,
        }


async def _create_firefox_profile(profile_name: str | None, profile_config: dict[str, Any] | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to create Firefox profile: {e!s}",
            "profile_name": profile_name,
        }
...
async def _delete_firefox_profile(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to delete Firefox profile: {e!s}",
            "profile_name": profile_name,
        }
...
async def _create_loaded_profile(
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to create loaded profile: {e!s}",
            "profile_name": profile_name,
            "source_profiles": source_profiles,
        }


async def _create_portmanteau_profile(profile_name: str | None, source_profiles: list[str] | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to create portmanteau profile: {e!s}",
            "profile_name": profile_name,
            "source_profiles": source_profiles,
        }
...
async def _suggest_portmanteau_profiles(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to suggest portmanteau profiles: {e!s}",
            "profile_name": profile_name,
            "suggestions": [],
            "count": 0,
        }
...
async def _create_loaded_profile_from_preset(profile_name: str | None, preset_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to create profile from preset: {e!s}",
            "profile_name": profile_name,
            "preset_name": preset_name,
        }
...
async def _check_firefox_status() -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to check Firefox status: {e!s}",
