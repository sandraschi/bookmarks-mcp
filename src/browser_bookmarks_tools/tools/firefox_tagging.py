...
from browser_bookmarks_tools.tools.firefox.folder_based_tagging import (
    batch_tag_from_folder,
    tag_from_folder,
)
from browser_bookmarks_tools.tools.firefox.year_based_tagging import (
    batch_tag_from_year,
    tag_from_year,
)
...
async def firefox_tagging(
    ...
    if operation == "tag_from_folder":
        return await _tag_from_folder(profile_name, folder_path, tag_prefix, include_subfolders, dry_run)
...
async def _tag_from_folder(
    ...
    try:
        ...
        result = await tag_from_folder(profile_name, folder_path, tag_prefix, include_subfolders, dry_run)
        ...
        return {
            "success": False,
            "error": f"Failed to tag from folder: {e!s}",
            "profile_name": profile_name,
            "folder_path": folder_path,
            "tagging_result": {},
        }
...
async def _batch_tag_from_folder(
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to batch tag from folder: {e!s}",
            "profile_name": profile_name,
            "folder_path": folder_path,
            "batch_result": {},
        }
...
async def _tag_from_year(
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to tag from year: {e!s}",
            "profile_name": profile_name,
            "year": year,
            "tagging_result": {},
        }
...
async def _batch_tag_from_year(
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to batch tag from year: {e!s}",
            "profile_name": profile_name,
            "year": year,
            "batch_result": {},
        }
