...
async def _bruteforce_read_operation(
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Brute force operation failed: {e!s}",
        }
...
async def _list_bookmarks(profile_name: str | None, folder_id: int | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to list bookmarks: {e!s}",
            "profile_name": profile_name,
            "bookmarks": [],
            "count": 0,
        }
...
async def _get_bookmark(bookmark_id: int | None, profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to get bookmark: {e!s}",
            "profile_name": profile_name,
            "bookmark_id": bookmark_id,
        }
...
async def _add_bookmark(
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to add bookmark: {e!s}",
            "profile_name": profile_name,
            "url": url,
        }
...
async def _search_bookmarks(profile_name: str | None, search_query: str | None, search_type: str) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to search bookmarks: {e!s}",
            "profile_name": profile_name,
            "search_query": search_query,
            "results": [],
            "count": 0,
...
async def _find_duplicates(profile_name: str | None, similarity_threshold: float) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to find duplicates: {e!s}",
            "profile_name": profile_name,
            "duplicates": [],
            "duplicate_groups": 0,
        }
...
async def _export_bookmarks(profile_name: str | None, export_format: str, export_path: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to export bookmarks: {e!s}",
            "profile_name": profile_name,
            "export_format": export_format,
        }


async def _batch_update_tags(profile_name: str | None, tags: list[str] | None, batch_size: int) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to update tags: {e!s}",
            "profile_name": profile_name,
            "tags": tags,
        }
...
async def _remove_unused_tags(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to remove unused tags: {e!s}",
            "profile_name": profile_name,
        }
...
async def _list_tags(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to list tags: {e!s}",
            "profile_name": profile_name,
            "tags": [],
            "count": 0,
        }
...
async def _find_similar_tags(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to find similar tags: {e!s}",
            "profile_name": profile_name,
            "similar_tags": [],
            "groups": 0,
        }
...
async def _merge_tags(profile_name: str | None, tags: list[str] | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to merge tags: {e!s}",
            "profile_name": profile_name,
            "merged_tags": tags,
        }
...
async def _clean_up_tags(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to clean up tags: {e!s}",
            "profile_name": profile_name,
        }
...
async def _find_old_bookmarks(profile_name: str | None, age_days: int) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to find old bookmarks: {e!s}",
            "profile_name": profile_name,
            "age_days": age_days,
        }
...
async def _find_forgotten_bookmarks(profile_name: str | None, age_days: int) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to find forgotten bookmarks: {e!s}",
            "profile_name": profile_name,
            "days_unvisited": age_days,
        }
...
async def _refresh_bookmarks(profile_name: str | None, batch_size: int) -> dict[str, Any]:
    ...
    try:
        ...
        # Process in batches
        for _i, bookmark in enumerate(bookmarks[:batch_size]):
        ...
        return {
            "success": False,
            "error": f"Failed to refresh bookmarks: {e!s}",
            "profile_name": profile_name,
            "old_bookmarks": [],
            "count": 0,
        }
...
async def _get_bookmark_stats(profile_name: str | None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to get bookmark stats: {e!s}",
            "profile_name": profile_name,
            "stats": {},
        }
...
async def _find_broken_links(profile_name: str | None, check_links: bool) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "success": False,
            "error": f"Failed to find broken links: {e!s}",
            "profile_name": profile_name,
            "broken_links": [],
            "count": 0,
        }
