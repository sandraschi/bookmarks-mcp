...
- backup_firefox_data()  firefox_backup(operation='backup')
...
async def backup_firefox_data(backup_dir: str | None = None, profile_name: str | None = None) -> dict[str, Any]:
...
async def restore_firefox_data(backup_path: str, profile_name: str | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return {"status": "error", "message": f"Restore failed: {e!s}"}
