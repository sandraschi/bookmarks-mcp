...
4. Start the server:
   ...
   uv run python -m bookmarks_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn bookmarks_mcp.server:app --port 10803
   ```
5. Open `http://localhost:10803` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/bookmarks-mcp/issues) |
