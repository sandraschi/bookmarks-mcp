    ...
    return (
        <div className="flex h-[calc(100vh-8rem)] flex-col space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-white">Bookmark Interface</h2>
                    <p className="text-slate-400">Natural language browser control (LLM)</p>
                </div>
            </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <p className="text-sm text-slate-300 bg-slate-900/50 p-3 rounded-md border border-slate-800 inline-block">
                                Find all bookmarks related to "Fastmcp" in Microsoft Edge.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <div className="text-sm text-slate-300 bg-blue-950/10 p-3 rounded-md border border-blue-900/30 inline-block">
                                <p>Searching bookmarks in Microsoft Edge...</p>
                                <br />
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2 p-2 bg-slate-900/80 rounded border border-slate-800">
                                        ...
                                        <span className="text-xs text-blue-300 truncate">FastMCP Documentation - GitHub</span>
                                    </div>
                                    <div className="flex items-center gap-2 p-2 bg-slate-900/80 rounded border border-slate-800">
                                        <Bookmark className="h-3 w-3 text-blue-400" />
                                        <span className="text-xs text-blue-300 truncate">MCP Standards - GitBook</span>
                                    </div>
                                </div>
                            </div>
                        </div>
