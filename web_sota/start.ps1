...
Stop-FleetPortSquatters -Ports @($WebPort, $BackendPort) -Label "bookmarks-mcp"

if (-not (Assert-FleetPortsAvailable -Ports @($WebPort, $BackendPort) -Label "bookmarks-mcp")) { exit 1 }
